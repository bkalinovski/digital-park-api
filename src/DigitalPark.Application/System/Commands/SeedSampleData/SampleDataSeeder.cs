...
public class SampleDataSeeder
{
    ...
    private async Task SeedLanguagesAsync(CancellationToken cancellationToken)
    {
        var languages = new[]
        {
            new Language { Code = "en", Title = "English" },
            new Language { Code = "ro", Title = "Romanian" }
        };
    ...
    private async Task SeedLocationsAsync(CancellationToken cancellationToken)
    {
        var locations = new[]
        {
            new Location
            {
                Id = Guid.Parse("05661C1F-6413-4DBB-BD8B-7CAEFAA8051B"), IsActive = true, CreatedAt = DateTime.Now, 
                Translations =
                {
                    new LocationTranslation { LocationId = Guid.Parse("05661C1F-6413-4DBB-BD8B-7CAEFAA8051B"), LanguageCode = "en", Title = "Technology Hall"},
                    new LocationTranslation { LocationId = Guid.Parse("05661C1F-6413-4DBB-BD8B-7CAEFAA8051B"), LanguageCode = "ro", Title = "Technology Hall"}
                }
            },
            
            new Location
            {
                Id = Guid.Parse("D564B15D-2623-4708-9A70-71FDD60AB7E6"), IsActive = true, CreatedAt = DateTime.Now, 
                Translations =
                {
                    new LocationTranslation { LocationId = Guid.Parse("D564B15D-2623-4708-9A70-71FDD60AB7E6"), LanguageCode = "en", Title = "Innovation Hall"},
                    new LocationTranslation { LocationId = Guid.Parse("D564B15D-2623-4708-9A70-71FDD60AB7E6"), LanguageCode = "ro", Title = "Innovation Hall"}
                }
            },
            
            new Location
            {
                Id = Guid.Parse("2AFDADC5-00F5-4ADD-989D-5DB59099C093"), IsActive = true, CreatedAt = DateTime.Now, 
                Translations =
                {
                    new LocationTranslation { LocationId = Guid.Parse("2AFDADC5-00F5-4ADD-989D-5DB59099C093"), LanguageCode = "en", Title = "Community Hall"},
                    new LocationTranslation { LocationId = Guid.Parse("2AFDADC5-00F5-4ADD-989D-5DB59099C093"), LanguageCode = "ro", Title = "Community Hall"}
                }
            },
            
            new Location
            {
                Id = Guid.Parse("F9754BD0-FE78-4E3A-922C-DF57E7E5BF01"), IsActive = true, CreatedAt = DateTime.Now, 
                Translations =
                {
                    new LocationTranslation { LocationId = Guid.Parse("F9754BD0-FE78-4E3A-922C-DF57E7E5BF01"), LanguageCode = "en", Title = "Lobby"},
                    new LocationTranslation { LocationId = Guid.Parse("F9754BD0-FE78-4E3A-922C-DF57E7E5BF01"), LanguageCode = "ro", Title = "Lobby"}
                }
            },
            
            new Location
            {
                Id = Guid.Parse("3B23D4BB-BB3F-437D-ADB3-428779BFC317"), IsActive = true, CreatedAt = DateTime.Now, 
                Translations =
                {
                    new LocationTranslation { LocationId = Guid.Parse("3B23D4BB-BB3F-437D-ADB3-428779BFC317"), LanguageCode = "en", Title = "Outdoor Space"},
                    new LocationTranslation { LocationId = Guid.Parse("3B23D4BB-BB3F-437D-ADB3-428779BFC317"), LanguageCode = "ro", Title = "Outdoor Space"}
                }
            },
            
            new Location
            {
                Id = Guid.Parse("50DA7309-272F-4E25-B457-3FC2BA3F8686"), IsActive = true, CreatedAt = DateTime.Now, 
                Translations =
                {
                    new LocationTranslation { LocationId = Guid.Parse("50DA7309-272F-4E25-B457-3FC2BA3F8686"), LanguageCode = "en", Title = "Digital Garden"},
                    new LocationTranslation { LocationId = Guid.Parse("50DA7309-272F-4E25-B457-3FC2BA3F8686"), LanguageCode = "ro", Title = "Digital Garden"}
                }
            }
        };
    ...
    private async Task SeedEventsAsync(CancellationToken cancellationToken)
    {
        ...
        var events = new[]
        {
            new Event
            {
                ...
                Translations =
                {
                    new EventTranslation { EventId = Guid.Parse("B8CD823E-46C5-4F6B-BD50-A1D6CF6423CB"), LanguageCode = "en", Title = "dotnetdays", Description = "random description en", Image = "http://cdnedge.starnet.md/digital-park-website/events/B8CD823E-46C5-4F6B-BD50-A1D6CF6423CB/dotnetdays-banner.png" },
                    new EventTranslation { EventId = Guid.Parse("B8CD823E-46C5-4F6B-BD50-A1D6CF6423CB"), LanguageCode = "ro", Title = "dotnetdays", Description = "random description ro", Image = "http://cdnedge.starnet.md/digital-park-website/events/B8CD823E-46C5-4F6B-BD50-A1D6CF6423CB/dotnetdays-banner.png" }
                },
                ...
                Contents = new List<EventContent>
                {
                    ...
                    new EventContent()
                    {
                        ...
                        Translations =
                        {
                            new EventContentTransation
                            {
                                EventContentId = 1, LanguageCode = "en", 
